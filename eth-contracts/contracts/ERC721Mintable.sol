...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(!_paused, "The contract needs to be unpaused");
        _;
    }

    modifier paused() {
        require(_paused, "The contract needs to be paused");
        _;
    }
    ...
    function setPaused(bool mode) public onlyOwner {
        require(mode != _paused, "The contract already is in that pause state");
        _paused = mode;
        if (_paused) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "The given address is the owner of the given token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == super.getOwner() || isApprovedForAll(ownerOf(tokenId), to), "The caller is not the owner of the contract and operator is not approved by owner");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "The given tokenId already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Given address is not the owner of that token");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "The address the token is being transferred to is not valid");
...
contract RealEstateERC721Token is ERC721Metadata("Real Estate Token", "RET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
